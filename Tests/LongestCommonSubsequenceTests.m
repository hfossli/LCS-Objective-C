...
/*
 ...
 XCTAssertEqual((int)commonIndexes.count, (int)5, @"number of common items mismatch");
 ...
 NSMutableArray *replica = [first mutableCopy];
 ...
 XCTAssert([second isEqualToArray:replica], @"Expecting to be able to reproduce the second array using the first - removed + added items");
 */
